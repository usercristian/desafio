  ...
  return (
    <aside 
      className={`
        ...
        bg-white dark:bg-gray-800 border border-happy-detail dark:border-gray-700 rounded-2xl shadow-2xl 
      ...
      <div className="p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-happy-blue scrollbar-track-gray-100 dark:scrollbar-track-gray-800 rounded-b-2xl">
        <div className="relative">
          ...
          <img 
            src={product.image} 
            alt={product.nome} 
            className="w-full h-48 object-contain mb-4 p-2 bg-white dark:bg-gray-700 rounded-lg"
          />
          
          <h4 className="text-xl font-bold text-center text-happy-text dark:text-gray-100 mb-1">
            {product.nome}
          </h4>
          
          <p className="text-center font-bold text-happy-blue-text dark:text-happy-blue text-sm mb-3">
          ...
          <hr className="border-happy-detail dark:border-gray-700 my-3" />

          <div className="space-y-3 text-sm text-gray-600 dark:text-gray-300 text-justify">
            <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg border border-green-100 dark:border-green-800 text-left">
              <h6 className="font-bold text-green-800 dark:text-green-300 mb-2 text-xs uppercase flex items-center gap-2">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border border-gray-100 dark:border-gray-600">
              <h6 className="font-bold text-black dark:text-gray-100 mb-1 text-xs uppercase">Por que as pessoas compram</h6>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border border-gray-100 dark:border-gray-600">
              <h6 className="font-bold text-black dark:text-gray-100 mb-1 text-xs uppercase">Descrição técnica</h6>
          ...
          <div className="mt-4 bg-cyan-50 dark:bg-cyan-900/30 border border-happy-detail dark:border-cyan-800 rounded-lg p-3 text-xs text-gray-700 dark:text-gray-300">
            <p className="font-bold text-happy-text dark:text-gray-100 flex items-center gap-2 mb-1">
