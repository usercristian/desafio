...
const AccordionItem = ({ title, isOpen, onClick, children }) => {
  return (
    <div className="mb-3 border border-happy-detail rounded-lg overflow-hidden bg-white shadow-sm">
      ...
      <div
        className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[1200px] opacity-100 border-t border-gray-100' : 'max-h-0 opacity-0'
          }`}
      >
        ...
        >
          ...
          <div className="w-full max-w-lg mx-auto h-80 pb-6">
            <Line
              ...
              role="img"
              aria-label="Gráfico de linha mostrando a projeção exponencial crescente do faturamento em milhares de reais conforme o aumento de marcos de 10 mil novos usuários."
            />
          </div>
        </AccordionItem>
