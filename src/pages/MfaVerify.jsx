...
const MfaVerify = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-grow py-10 px-4">
      <div className="w-full max-w-[420px] bg-white dark:bg-gray-800 rounded-[15px] p-8 shadow-[0_0_20px_rgba(5,217,232,0.1)] border border-gray-50 dark:border-gray-700">
        ...
        <div className="text-center mb-6">
          <h1 className="text-xl font-bold text-happy-text dark:text-gray-100 mb-1">Verificação em duas etapas</h1>
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex-1 py-2 rounded-lg font-bold transition-colors ${!useRecoveryCode ? 'bg-happy-pink text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300'}`}
          >
            App autenticador
          </button>
          <button
        ...
        <form onSubmit={handleSubmit}>
          {!useRecoveryCode && (
            <div className="mb-4">
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 ml-1">Código TOTP</label>
              <input
                type="text"
                value={code}
          ...
          {useRecoveryCode && (
            <div className="mb-4">
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 ml-1">Código de recuperação</label>
              <input
                type="text"
                value={recoveryCode}
        ...
        <div className="text-center mt-4 text-sm">
          <Link
            ...
            className="text-happy-blue-text dark:text-happy-blue hover:underline"
          >
            Voltar para o login
          </Link>
        </div>
