...
const Checkout = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-4xl">
      <h2 className="text-2xl font-bold text-happy-text mb-6">Confirmação de compra</h2>

      {/* Resumo de Valores */}
      <section className="bg-white p-6 rounded-xl shadow-card mb-6 border border-gray-100">
        <h3 className="text-lg font-bold mb-4">Revise e confirme</h3>
        ...
        <div className="mt-6 text-center">
          {!isConfirmed ? (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 animate-fade-in">
              <div className="flex flex-col items-center text-green-700 gap-2 mb-3">
      ...
      {/* Detalhes de Entrega */}
      <section className="bg-white p-6 rounded-xl shadow-card mb-6 border border-gray-100">
        <h4 className="font-bold text-lg mb-3">Detalhes da entrega</h4>
